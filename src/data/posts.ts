...
export const POSTS: ReadonlyArray<Post> = [
  ...
  {
    slug: "agil-de-verdad-scrum-equipo-chico",
  ...
  {
    slug: "la-ux-como-prioridad",
    title: "Interfaces bonitas no son lujo: la UX como prioridad",
    excerpt: "La experiencia gana sobre la lista de features.",
    pillar: "ux",
    date: "2026-06-22",
    status: "published",
    hero: "/blog/la-ux-como-prioridad/la-ux-como-prioridad-hero.webp",
    heroAlt: "Wireframe de una interfaz web dibujado a mano sobre papel.",
  },
  {
